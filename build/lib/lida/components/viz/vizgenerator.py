...
For large datasets (with more than 100,000 rows), ALWAYS apply data reduction techniques like downsampling, aggregation, or use a tool like Datashader to avoid overplotting. Make sure the generated code scales efficiently with data size.
"""
