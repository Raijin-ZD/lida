...
Recommend visualizations that are optimized for large datasets. For datasets with more than 100,000 rows, prefer visualizations that use data aggregation, such as density maps, summary plots, or Datashader-based techniques.
...
class VizRecommender(object):
    ...
    def generate(
        ...
        if len(summary.fields) > 100000:
             structure_instruction += "\nInclude `datashader` as an import for visualizing large datasets.\n"
