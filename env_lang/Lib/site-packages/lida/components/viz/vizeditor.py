...
You MUST check if the dataset is large. For datasets larger than 100,000 rows, ALWAYS recommend data aggregation, downsampling, or using Datashader for visualization.
